...
import '../../css/main.css';
class CourseFivePageBodyDetails_Second extends React.Component {
  render() {
    return (
              ...
              <div class="title text-center">
                ...
                <div>
                  ...
                  <p class="header-gap" align="justify">
                    ...
                    three days extensive class room teaching is followed by practical sessions on simulator. Assignment containing questions
                    pertaining to days curriculum are given and discussion on assignment is taken up in the next morning.
                  </p>
                  <p align="justify">
                    On fourth day a mock test is conducted which is an in- house test based on IWCF pattern. This is to access the
                    performance of the participants and prepare them for the final test. Individual attention is given to the participants
                    based on the results of the Mock test. Simulator Practical Assessment. On fifty day, there will be written examination
                    and certification.
                  </p>
                  <p align="justify">
                    DAY 1 : Well Control Event & Incident, Well Control Training Assessment, Risk Management, Introduction to Well Control
                    and Pressure, Barrier Concept, Kick and Concept of Bottomhole Pressure, Kick warning Sign and Kick Indicator
                    (Detection), Top Hole Drilling, Kill Sheet preparation, Simulator hand on practice.
                  </p>
                  <p align="justify">
                    DAY 2: Assignment Discussion, Concept of Circulating System, Concept of Fracture Pressure and MAASP, Influx
                    Characteristic and its behavior, Shut in Procedure, Gas Migration, Well Control Method, Kill Sheet preparation,
                    Simulator hand on practice.
                  </p>
                  <p align="justify">
                    DAY 3: Assignment Discussion, Volumetric Method, Stripping, Well Control During Casing and Cementing Operation, Well
                    control Management, Contigency Planning, Well Control Equipment, Ram Type Preventer, Associated Well Control Equipment,
...
export default CourseFivePageBodyDetails_Second;
